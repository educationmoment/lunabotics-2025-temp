...
#include "interfaces_pkg/msg/detail/duty_cycle_output__rosidl_typesupport_fastrtps_c.h"
...
using _DutyCycleOutput__ros_msg_type = interfaces_pkg__msg__DutyCycleOutput;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _DutyCycleOutput__ros_msg_type * ros_message = static_cast<const _DutyCycleOutput__ros_msg_type *>(untyped_ros_message);
  // Field name: left_drive_output
  {
    cdr << ros_message->left_drive_output;
  }

  // Field name: right_drive_output
  {
    cdr << ros_message->right_drive_output;
  }

  // Field name: left_lift_output
  {
    cdr << ros_message->left_lift_output;
  }

  // Field name: right_lift_output
  {
    cdr << ros_message->right_lift_output;
  }

  // Field name: tilt_output
  {
    cdr << ros_message->tilt_output;
  }

  // Field name: vibrator_output
  {
  ...
  void * untyped_ros_message)
{
  ...
  _DutyCycleOutput__ros_msg_type * ros_message = static_cast<_DutyCycleOutput__ros_msg_type *>(untyped_ros_message);
  // Field name: left_drive_output
  {
    cdr >> ros_message->left_drive_output;
  }
...
size_t get_serialized_size_interfaces_pkg__msg__DutyCycleOutput(
  const void * untyped_ros_message,
...
static uint32_t _DutyCycleOutput__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_interfaces_pkg__msg__DutyCycleOutput(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_interfaces_pkg
size_t max_serialized_size_interfaces_pkg__msg__DutyCycleOutput(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interfaces_pkg__msg__DutyCycleOutput;
    is_plain =
      (
...
static size_t _DutyCycleOutput__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_interfaces_pkg__msg__DutyCycleOutput(
...
static message_type_support_callbacks_t __callbacks_DutyCycleOutput = {
  "interfaces_pkg::msg",
  "DutyCycleOutput",
...
static rosidl_message_type_support_t _DutyCycleOutput__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_DutyCycleOutput,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, interfaces_pkg, msg, DutyCycleOutput)() {
  return &_DutyCycleOutput__type_support;
}
